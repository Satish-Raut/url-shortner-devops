  ...
  const features = [
    {
      ...
      description:
        "Our URLs redirect in milliseconds, ensuring your audience gets to where they need to go without delay.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Track every click in real-time. Understand your audience with detailed geographical and device data.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "We take your privacy seriously. All links are encrypted and protected against malicious redirects.",
      icon: (
        <svg
